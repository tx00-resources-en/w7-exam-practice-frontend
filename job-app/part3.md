...
| Folder | Purpose |
|---|---|
| `job-app/backend-protect/` | Same Express API from Part 2 (signup, login, protected routes). |
| `job-app/frontend/step7/` | Your **starting point** for Iteration 8. Copy this folder and work inside the copy. |
| `job-app/frontend/step8/` | Sample solution for Iteration 8. Only look at it **after** you have tried on your own. |
